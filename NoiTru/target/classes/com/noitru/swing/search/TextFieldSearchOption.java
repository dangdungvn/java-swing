package com.noitru.swing.search;
...
public class TextFieldSearchOption extends JTextField {
    ...
    private Color colorOverlay1 = new Color(252, 252, 252);
    private Color colorOverlay2 = new Color(93, 93, 93);
    private String hint = "Search...";

    public TextFieldSearchOption() {
        setBorder(new EmptyBorder(10, 10, 10, 40));
        setSelectionColor(new Color(130, 130, 130));
