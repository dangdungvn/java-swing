...
public class Form_BenhNhan extends javax.swing.JPanel {
    ...
    private void themData() {
        themBtn.addActionListener(e -> {
            try {
                ...
                String NgayDKKham = (LocalDate.now().minusDays(1)).toString();
                ...
                Logger.getLogger(Form_BenhNhan.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        for (Model_BenhNhan benhNhan : benhNhanListTK) {
                            Object[] row = {benhNhan.getMaBN(), benhNhan.getTenBN(),
                                ...
                                benhNhan.getBHYT(), benhNhan.getDienThoai(), benhNhan.getNgayDKKham(), benhNhan.getNgayRaVien()};
                            table.addRow(row);
                        }
                    });
                }
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        for (Model_BenhNhan benhNhan : benhNhanListTK) {
                            Object[] row = {benhNhan.getMaBN(), benhNhan.getTenBN(),
                                ...
                                benhNhan.getGioiTinh(),
                                benhNhan.getCCCD(), benhNhan.getDiaChi(),
                                benhNhan.getBHYT(), benhNhan.getDienThoai(), benhNhan.getTinhTrang(), benhNhan.getNgayDKKham(), benhNhan.getNgayRaVien()};
                            table.addRow(row);
                        }
                    });
                }
