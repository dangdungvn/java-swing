...
public class Form_DieuTriHangNgay extends javax.swing.JPanel {

    int ThanhTien = 0;

    public Form_DieuTriHangNgay() {
        initComponents();
        ...
        loadCB();
        addData();
        nnvEdt.setEnabled(false);
        ngayEdt.setEnabled(false);
    }
    ...
    private void addData() {
        kedonBtn.addActionListener((ActionEvent e) -> {
            try {
                ...
                String Thuoc = thuocCb.getSelectedItem().toString();
                int SoLuongThuoc = Integer.parseInt(sltEdt.getText().trim());
                ThanhTien = ThanhTien * Integer.parseInt(sltEdt.getText().trim());
                DieuTri.addThongTin(maBN, soNgay, Ngay, Thuoc, SoLuongThuoc, ThanhTien);
                loadDB();
            } catch (ParseException ex) {
                Logger.getLogger(Form_DieuTriHangNgay.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }

    private void loadCB() {
        List<Model_BenhNhan> ttkbList = BenhNhan.timKiemBNChuaXuatVien();
        for (Model_BenhNhan mdt : ttkbList) {
            mbnCb.addItem(mdt.getMaBN());
        }
        List<Model_Thuoc> thuocList = GiaThuoc.getAllThongTin();
        for (Model_Thuoc mt : thuocList) {
            thuocCb.addItem(mt.getThuoc());
        }
        thuocCb.addActionListener((ActionEvent e) -> {
            String TenThuoc = thuocCb.getSelectedItem().toString();
            List< Model_Thuoc> thuocListTK = GiaThuoc.timKiemTheoMaBN(TenThuoc);
            for (Model_Thuoc model_Thuoc : thuocListTK) {
                ThanhTien = (int) model_Thuoc.getGiaTien();
            }
        });
        ngayEdt.setText(LocalDate.now().toString());
        mbnCb.addActionListener((ActionEvent e) -> {
            String text = mbnCb.getSelectedItem().toString();
            if (text != null && !text.equals("--Chọn Mã BN--")) {
                List<Model_BenhNhan> ngayNhapVienList = BenhNhan.timKiemTheoMaBN(text);
                for (Model_BenhNhan mbn : ngayNhapVienList) {
                    String ngayHienTai = LocalDate.now().toString();
                    String ngayDKKham = mbn.getNgayDKKham();
                    ...
                    long ngayNhapVien = ChronoUnit.DAYS.between(nDKKham, nHienTai);
                    nnvEdt.setText(String.valueOf(ngayNhapVien));
                }
    ...
    private void initComponents() {
        ...
        thuocCb = new com.noitru.swing.jcombosuggestion.ComboBoxSuggestion();
        ...
        thuocCb.setBackground(new java.awt.Color(204, 204, 255));
        thuocCb.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Chọn Thuốc--" }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(ngayEdt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(sltEdt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel3)
                        .addComponent(nnvEdt, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(thuocCb, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(ttEdt, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 44, Short.MAX_VALUE)
                        .addComponent(kedonBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(thuocCb, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sltEdt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ngayEdt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(191, 191, 191)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 32, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kedonBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private com.noitru.swing.jcombosuggestion.ComboBoxSuggestion thuocCb;
