...
//        spTable.setCorner(JScrollPane.UPPER_RIGHT_CORNER, p);
            ...
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedRow != -1) {
                    ...
                    for (Model_ThongTinKhamBenh benhNhan : ttkbList) {
                        ...
                        nnvEdt.setText(String.valueOf(benhNhan.getSoNgayNhapVien()));
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    ThongTinKhamBenh.suaThongTin(MaBS, NgayKham, PhongKham, MaBN, ChuyenKhoa, CanNang, NhomMau, NhietDo,
                            ...
                            SoNgayNhapVien, HuongDieuTri);
                    loadDB();
                } catch (ParseException ex) {
                    Logger.getLogger(Form_7.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        nnvEdt.setShadowColor(new java.awt.Color(153, 153, 255));
                            ...
                            .addGroup(panelBorder1Layout.createSequentialGroup()
                                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(nnvEdt, javax.swing.GroupLayout.PREFERRED_SIZE, 335, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(panelBorder1Layout.createSequentialGroup()
                                            .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
