...
public class Form_KhamBenh extends javax.swing.JPanel {
...
//        mbsCb.setEnabled(false);
    ...
    private void loadDBtoComboBox() {
        ...
        List<String> dataPK = ThongTinKhamBenh.getAllPhongKham();
        for (String string : dataPK) {
            pkCb.addItem(string);
        }
        ...
        ckCb.addActionListener((ActionEvent e) -> {
            String selectedChuyenKhoa = (String) ckCb.getSelectedItem();
    ...
    private void updateDB() {
        luuBtn.addActionListener((ActionEvent e) -> {
            try {
                ...
                if (ThongTinKhamBenh.addThongTin(MaBS, NgayKham, PhongKham, MaBN,
                        ChuyenKhoa, CanNang, NhomMau, NhietDo,
                        Mach, HuyetAp, NhipTho, LyDoKham,
                        TinhTrangHienTai, ChuanDoanSoBo, HuongDieuTri)) {
                    JOptionPane.showMessageDialog(this, "Đã Add");
                    BenhNhan.suaBenhNhanTheoTinhTrang(MaBN, "Đã Khám");
                } else {
                    JOptionPane.showMessageDialog(this, "Khai Báo Thông Tin Sai!");
                }
            ...
            .addGroup(panelBorder3Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder3Layout.createSequentialGroup()
                        ...
                        .addGap(118, 401, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder3Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBorder2Layout.createSequentialGroup()
                        .addGroup(panelBorder2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(ckCb, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
