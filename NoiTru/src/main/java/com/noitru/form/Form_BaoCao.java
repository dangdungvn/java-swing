...
public class Form_BaoCao extends javax.swing.JPanel {
            ...
            if (text != null && !text.equals("--Chọn Mã BS--")) {
                ...
                SwingUtilities.invokeLater(() -> {
                    for (Model_BaoCao thongTinKhamBenh : thongTinKhamBenhList) {
                        ...
                        String ngayDKKham = thongTinKhamBenh.getNgayDKKham();
                        ...
                        Object[] row = {thongTinKhamBenh.getTenBN(), thongTinKhamBenh.getDiaChi(), thongTinKhamBenh.getCCCD(),
                            ...
                            thongTinKhamBenh.getHuongDieuTri(), ngayNhapVien, thongTinKhamBenh.getTinhTrang()};
                        table.addRow(row);
                    }
                });
            } else {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TenBN", "Địa Chỉ", "CCCD", "Giới Tính", "Chuẩn Đoán", "Chuyên Khoa", "Hướng Điều Trị", "Số Ngày NV", "TinhTrang"
            }
        ) {
